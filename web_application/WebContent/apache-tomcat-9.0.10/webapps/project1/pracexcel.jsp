    ...
    {		//not reading column header
        Vector cellStoreVector = (Vector) cellVectorHolder.elementAt(i);
              ...
              //int prn1=399;
               ...
               //int k=stat.executeUpdate("insert into "+year+"_"+sub+"_practical values('"+stringCellValue+"','"+stringCellValue1+"','"+stringCellValue2+"','"+stringCellValue3+"','"+stringCellValue4+"','"+stringCellValue5+"','"+stringCellValue6+"')");
               str="update "+year+"_"+sub+"_practical set ";
               
	}
    response.sendRedirect("prac.jsp?a="+fileName+"&sub="+sub+"&year="+year);
    }catch(Exception e)
    {
