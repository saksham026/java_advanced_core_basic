...
%>
<h1><%=sub %> Practical marks</h1>
<form method="post" action="addprac.jsp?sub=<%=sub%>&year=<%=year%>">
...
%>
<td>
<a href="editprac.jsp?&prn=<%=rs.getInt(1)%>">edit</a>
</td>
</tr>
<%
	}
...
<button><a href="calculateut.jsp?sub=<%=sub%>&year=<%=year%>" style="text-decoration:none" style="text-decoration:none">move to next page</a></button>
