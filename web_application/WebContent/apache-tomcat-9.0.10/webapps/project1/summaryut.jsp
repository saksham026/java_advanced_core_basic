...
try
{
	...
	if(flag5==1)
	{
			response.sendRedirect("summaryprac.jsp?sub="+sub+"&year="+year);
	}
	...
	String str1="select count(*) as Number from information_schema.columns where table_name='"+year+"_"+sub+"_unit'";
...
<%
	...
	String str123="select * from "+year+"_"+sub+"_unit";
...
j++;
	...
	for(int y=0;y<t;y++)
	{
		System.out.println(totalcoy[y]);
		float t=(float)totalcoy[y]/entries*100;
		System.out.println(t);
		String str1234="update "+year+"_"+sub+"_cosum set unit="+t+" where co='co"+(y+1)+"'"; 
...
<button><a href="summaryprac.jsp?sub=<%=sub%>&year=<%=year%>" style="text-decoration:none">move to next page</a></button>
