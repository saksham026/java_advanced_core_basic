...
if(file1!=null)
{
	...
	response.sendRedirect("examexcel.jsp?a="+file1+"&sub="+sub+"&year="+year);
...
int no=1;
String str2="select count(*) as Number from information_schema.columns where table_name='"+year+"_"+sub+"_exam'";
...
String str1="insert into "+year+"_"+sub+"_exam values(?";
...
if(b=true)
{
	response.sendRedirect("exam.jsp?a="+file1+"&sub="+sub+"&year="+year);
}
ps.close();
}
