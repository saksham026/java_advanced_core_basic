...
<body>
<h1><%=sub %> Class Assignment attainment</h1>
<%!
	String sub="DMKD";
	String year="2025";
	int sum=0,sum1=0;
...
try
{
	...
	if(flag5==1)
	{
			response.sendRedirect("calculateprac.jsp?sub="+sub+"&year="+year);
	}
...
for(int y=0;y<t;y++)
{
	String str123="update "+year+"_"+sub+"_comix set assessment="+totalcoy[y]+" where co='co"+(y+1)+"'"; 
...
<button><a href="calculateexam.jsp?sub=<%=sub%>&year=<%=year%>" style="text-decoration:none">move to next page</a></button>
