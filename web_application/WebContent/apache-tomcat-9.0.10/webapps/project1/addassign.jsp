...
if(file1!=null)
{
	...
	response.sendRedirect("assignexcel.jsp?a="+file1+"&sub="+sub+"&year="+year);
...
String str1="insert into "+year+"_"+sub+"_assessment values(?";
...
if(b=true)
{
	response.sendRedirect("assign.jsp?a="+file1+"&sub="+sub+"&year="+year);
}
ps.close();
}
